...
const JobCard = ({ job }) => {
    return (
        <div className="bg-gray-100 shadow-md rounded-lg p-4 mb-4">
            <h2 className="text-2xl lg:text-xl font-bold mb-2">{job.name}</h2> {/* Decreased font size for better readability on mobile */}
            <p className="text-0.5xl lg:text-xl  mb-2">{job.description}</p>
